...
var SFX = (function(){
    ...
    loadSource('blip',        1.0);  // normal Coin pickup
    loadSource('blip2',       1.0);  // big Coin pickup
    loadSource('explosion',   1.0);  // RotateObstacle collision
    loadSource('whoosh',      0.1);  // RotateObstacle successfully avoided (raw file is hot — 10% to sit under blips)
